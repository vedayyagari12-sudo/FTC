...
@Autonomous(name = "Ftcauto_Close_blue")
public class Ftcauto_Close_blue extends LinearOpMode {
...
// ---------------- AUTO PATH ----------------
    ...
    turnToAngle(-6.7, 0.7);
    ShootingLogic(3);
    sleep(1000);//Drives back shoots and wait for 1 second to finish shooting
    ...
    turnToAngle(42, 0.7);
    ShootingLogic(3); 
    sleep(1000); //Turns and strafes to the next rows of balls strafe and turn back and shoots then wait of for second to finish
    ...
    turnToAngle(34,0.6);
    ShootingLogic(6);  
    sleep(1000);//turns back and strafes to collect more balls then goes back to the last shooting point to shoot them then wait 1 second to finish
